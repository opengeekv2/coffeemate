class Coffee < ApplicationRecord
    ...
    def generate_taste_vector(all_taste_notes, coffee_taste_notes)
        taste_notes_vector = all_taste_notes.map { |taste_note|
            next "1" if coffee_taste_notes.any? {|coffee_taste_note| coffee_taste_note == taste_note }
            "0"
        }
    ...
    def update_taste_vector(taste_note = nil)
        ...
        taste_vector = self.generate_taste_vector(all_taste_notes, self.taste_notes)
